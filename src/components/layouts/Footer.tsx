...
const Footer: FC<FooterProps> = ({ className = '' }) => {
	return (
		<footer
			className={`relative px-4 lg:px-0 z-10 dark:bg-secondary dark:text-white bg-white pt-20 pb-10 lg:pt-[120px] lg:pb-20 ${className}`}
		>
				...
				<span className="absolute left-0 bottom-0 z-[-1]">
					...
					>
						...
						<defs>
							...
							>
								<stop stopColor="#fccc37" stopOpacity="0.08" />
								<stop offset="1" stopColor="#fccc37" stopOpacity="0" />
							</linearGradient>
						</defs>
					</svg>
				</span>
					...
					>
						...
						<defs>
							<linearGradient
								...
								gradientUnits="userSpaceOnUse"
							>
								<stop stopColor="#fccc37" stopOpacity="0.31" />
								<stop offset="1" stopColor="#fccc37" stopOpacity="0" />
							</linearGradient>
						</defs>
					</svg>
